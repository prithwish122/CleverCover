...
const Home: FC = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(https://images.pexels.com/photos/7818239/pexels-photo-7818239.jpeg)`, // Replace with your image URL
            ...
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-7xl font-extrabold text-white shadow-md">
                        Stand Out in Your Job Search: Tailored Cover Letters Made Easy!
                    </h1>
                </div>
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        This cover letter AI bot app is designed to revolutionize the job application process, offering an interactive and personalized experience for job seekers. With the help of an AI-powered chatbot, users can craft compelling cover letters, ask for tips, and receive instant feedback tailored to their unique skills and experiences.
                        <br />
                        <br />
                        Example prompts include:
                        <br />
                        <br />
                        👉 “Can you help me write a cover letter for a marketing position?”<br />
                        👉 “What are the key elements to include in a cover letter?”<br />
                        👉 “How can I highlight my skills effectively?”<br />
                        👉 “What should I avoid when writing my cover letter?”<br />
                        👉 “Can you provide examples of strong opening lines?”<br />
                        👉 “How do I customize my cover letter for different job applications?”<br />
                        <br />
                        This app aims to make the cover letter writing process straightforward and effective, empowering users to present their best selves to potential employers. By leveraging AI to provide real-time assistance and guidance, it boosts confidence and enhances the chances of landing that dream job.
                    </p>
                </div>
            </div>
